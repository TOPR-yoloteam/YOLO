...
class RaspberryPiOCRPipeline:
    def __init__(self,model, resolution=(320, 240), frame_interval=0.5, recording_duration=5, save_images=False):
        self.model = model
    ...
    def preprocess_and_ocr(self, frame, frame_index):
        ...
        if self.save_images:
            os.chdir("C:/Users/Valentin.Talmon/PycharmProjects/YOLO/src/license_plate_recognition/scripts/")
    ...
    def process_frames(self):
        ...
        while True:
            ...
            licence_plate_frame = self.get_licence_plate(frame)
            ocr_results = self.preprocess_and_ocr(licence_plate_frame, frame_index)
            frame_index += 1
