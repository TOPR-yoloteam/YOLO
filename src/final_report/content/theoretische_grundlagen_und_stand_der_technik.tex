...
\begin{figure}[H]
    ...
    \caption{YOLO-Architektur: Das Bild wird in ein Gitter unterteilt, jede Zelle sagt Bounding Boxes und Klassenwahrscheinlichkeiten voraus. Quelle: Redmon et al., 2016}
    \label{fig:yolo_grid}
\end{figure}
