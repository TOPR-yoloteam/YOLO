...
Zusätzlich wurde der \texttt{Mesh Confidence Score} betrachtet, der durchgehend sehr hoch ($\approx 0{,}96{-}0{,}98$) ausfiel. Daraus lässt sich schließen, dass die erkannten Gesichter nicht nur zuverlässig detektiert, sondern auch präzise vermesht wurden.
