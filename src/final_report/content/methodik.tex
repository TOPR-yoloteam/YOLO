...
Der vollständige Code, der die hier beschriebene Gesichtswiedererkennung mit den Gesichtspunkten mit MediaPipe implementiert, ist auf GitHub \cite{github_yolo} verfügbar.
Der ganze Code ist in Python geschrieben.
