...
Der vollständige Code ist in der Datei \texttt{face\_recognition\_yolo.py} zu finden und auf GitHub\cite{github_yolo} verfügbar. Zuerst werden die notwendigen Bibliotheken importiert, darunter \texttt{os}, \texttt{cv2}, \texttt{numpy}, \texttt{time}, \texttt{ultralytics} (für YOLO), \texttt{face\_recognition} und \texttt{datetime}.
