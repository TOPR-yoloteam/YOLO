...
Die Augfabenstellung war die Analyse und Bewertung die Performance der MediaPipe Gesichtserkennung und Gesichtswiedererkennung.
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{data/Vergleich_Confidence_50_vs_80.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{data/FPS_ueber_Zeit.png}
